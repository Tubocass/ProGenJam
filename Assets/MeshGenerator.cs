...
public class MeshGenerator : MonoBehaviour {
	...
	public void GenerateMesh(Coord room)
	{
	}
	...
	{
		int tileType;
		int	seed = Time.time.ToString();
		System.Random pseudoRandom = new System.Random(seed.GetHashCode());

		float p = Mathf.PerlinNoise(pseudoRandom.Next(0,100)*0.69f,pseudoRandom.Next(0,100)*0.69f)*mats.Length;
